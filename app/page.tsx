...
const sections = [
  ...
  },
  {
    ...
    body: 'قصص ملهمة من التاريخ الإسلامي ومحتوى مرئي يغذي الروح والعقل.',
    href: '/stories',
    icon: '🎬',
  },
  {
  ...
  },
  {
    ...
    body: 'روائع الشعر الإسلامي من البردة إلى قصائد الحكمة، واكتب قصائدك الخاصة.',
    href: '/poetry',
    icon: '✨',
  },
  {
  ...
  {
    title: 'خطة الحفظ',
    body: 'خطط مخصصة لحفظ القرآن الكريم مع متابعة التقدم والإنجازات.',
    href: '/memorization',
    icon: '🏆',
  },
];
