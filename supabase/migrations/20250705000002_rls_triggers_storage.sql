-- =============================================================================
-- Migration: 20250705000002_rls_triggers_storage
...
-- Public content tables (read-only for all, write only for admins via service role)
...
-- ---------------------------------------------------------------------------
-- 5. RLS Policies — User-owned tables (generic pattern)
-- ---------------------------------------------------------------------------
...
-- generated_research (accessible via join to research_requests)
...
-- reciter / recent recitation tables
...
-- saved_stories / story_progress (legacy users)
...
-- site_settings / video_publishing_config: public read
...
-- avatars bucket: users manage their own avatar
