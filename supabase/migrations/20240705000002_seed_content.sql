...
-- ─────────────────────────────────────────────────────────────────────────────
ALTER TYPE category ADD VALUE IF NOT EXISTS 'prophets';
ALTER TYPE category ADD VALUE IF NOT EXISTS 'sahaba';
ALTER TYPE category ADD VALUE IF NOT EXISTS 'documentaries';
ALTER TYPE category ADD VALUE IF NOT EXISTS 'history';
...
('ibn-taymiyyah', 'شيخ الإسلام ابن تيمية', 'Ibn Taymiyyah',
 'أحمد بن عبد الحليم بن تيمية الحراني (661-728هـ)، شيخ الإسلام وأحد أعظم علماء الأمة. برع في الفقه والحديث والعقيدة والتفسير والأصول. له مؤلفات كثيرة أشهرها مجموع الفتاوى ودرء تعارض العقل والنقل.',
...
('ibn-qayyim', 'ابن القيم الجوزية', 'Ibn Qayyim Al-Jawziyyah',
 'محمد بن أبي بكر بن أيوب (691-751هـ)، تلميذ ابن تيمية النجيب، ومن أعظم علماء الإسلام في التزكية والسلوك والفقه. من أشهر كتبه: مدارج السالكين وزاد المعاد وإعلام الموقعين.',
...
('nawawi', 'الإمام النووي', 'Imam An-Nawawi',
 'يحيى بن شرف النووي (631-676هـ)، محدث وفقيه شافعي، صاحب الأربعين النووية ورياض الصالحين وشرح صحيح مسلم. من أكثر العلماء تأثيراً في تاريخ الأمة.',
...
('ibn-baz', 'الشيخ عبد العزيز بن باز', 'Sheikh Ibn Baz',
 'عبد العزيز بن عبد الله بن باز (1330-1420هـ)، المفتي العام للمملكة العربية السعودية ورئيس هيئة كبار العلماء، من أبرز علماء العصر الحديث في الفقه والحديث.',
...
('uthaymin', 'الشيخ محمد بن صالح العثيمين', 'Sheikh Ibn Uthaymin',
 'محمد بن صالح العثيمين (1347-1421هـ)، من أبرز علماء المملكة العربية السعودية، له شروحات قيمة في الفقه والعقيدة، اشتهر بأسلوبه التعليمي الميسّر.',
...
('albani', 'الشيخ محمد ناصر الدين الألباني', 'Sheikh Al-Albani',
 'محمد ناصر الدين الألباني (1332-1420هـ)، محدث العصر، صحح وضعّف آلاف الأحاديث وله جهود عظيمة في خدمة السنة النبوية وتنقيتها.',
...
('shaarawi', 'الشيخ محمد متولي الشعراوي', 'Sheikh Al-Shaarawi',
 'محمد متولي الشعراوي (1911-1998م)، من أشهر المفسرين المعاصرين، له خواطر في تفسير القرآن الكريم انتشرت في العالم العربي والإسلامي.',
...
('saadi', 'الشيخ عبد الرحمن السعدي', 'Sheikh As-Saadi',
 'عبد الرحمن بن ناصر السعدي (1307-1376هـ)، عالم ومفسر، صاحب تفسير تيسير الكريم الرحمن المعروف بتفسير السعدي، من أيسر التفاسير وأنفعها.',
...
('abu-bakr', 'أبو بكر الصديق', 'Abu Bakr As-Siddiq',
 'عبد الله بن أبي قحافة، أول الخلفاء الراشدين، ورفيق النبي صلى الله عليه وسلم في الهجرة، وأول من آمن من الرجال. لُقّب بالصديق لتصديقه النبي في كل ما جاء به.',
...
('umar-ibn-khattab', 'عمر بن الخطاب', 'Umar ibn Al-Khattab',
 'الفاروق، ثاني الخلفاء الراشدين، اتسعت في عهده الفتوحات الإسلامية، واشتهر بعدله وقوته في الحق. أسلم فأعزّ الله به الإسلام.',
...
('ali-ibn-abi-talib', 'علي بن أبي طالب', 'Ali ibn Abi Talib',
 'ابن عم النبي صلى الله عليه وسلم وزوج ابنته فاطمة، رابع الخلفاء الراشدين، وأول من أسلم من الصبيان، اشتهر بعلمه وشجاعته.',
...
('badr', 'غزوة بدر الكبرى', 'Battle of Badr',
 'أول معركة فاصلة في تاريخ الإسلام، انتصر فيها المسلمون على قريش رغم قلة عددهم، وسمّاها الله يوم الفرقان. كان عدد المسلمين 313 مقابل نحو 1000 من المشركين.',
...
('uhud', 'غزوة أحد', 'Battle of Uhud',
 'معركة وقعت قرب جبل أحد، ابتُلي فيها المسلمون بعد مخالفة الرماة لأمر النبي صلى الله عليه وسلم، واستُشهد فيها حمزة بن عبد المطلب أسد الله.',
...
('khandaq', 'غزوة الخندق (الأحزاب)', 'Battle of the Trench',
 'حاصرت الأحزاب المدينة، فحفر المسلمون خندقاً بمشورة سلمان الفارسي، فردّ الله الأحزاب بريح وجنود لم يروها دون قتال كبير.',
...
('makkah', 'فتح مكة', 'Conquest of Makkah',
 'دخل النبي صلى الله عليه وسلم مكة فاتحاً في عشرة آلاف من المسلمين دون قتال يُذكر، وعفا عن أهلها فدخل الناس في دين الله أفواجاً.',
 'The peaceful conquest of Makkah by the Prophet, marked by his forgiveness of its people.', '8 هـ', '630 م', 'مكة المكرمة', 'Makkah', 'النبي محمد ﷺ', 'Prophet Muhammad ﷺ', 1, true),
('quds', 'فتح بيت المقدس', 'Conquest of Jerusalem',
 'فُتحت بيت المقدس في عهد عمر بن الخطاب صلحاً، وتسلّم مفاتيحها بنفسه، وكتب لأهلها العهدة العمرية التي أمّنتهم على أنفسهم وكنائسهم.',
 'Jerusalem was peacefully surrendered to Caliph Umar, who granted its people the famous Covenant of Umar.', '15 هـ', '637 م', 'بيت المقدس', 'Jerusalem', 'عمر بن الخطاب', 'Umar ibn Al-Khattab', 2, true),
('misr', 'فتح مصر', 'Conquest of Egypt',
 'فتح عمرو بن العاص مصر في عهد عمر بن الخطاب، وأسّس مدينة الفسطاط، فدخلت مصر في ظل الحضارة الإسلامية.',
 'Amr ibn al-As conquered Egypt during Umar''s caliphate and founded the city of Fustat.', '20 هـ', '641 م', 'مصر', 'Egypt', 'عمرو بن العاص', 'Amr ibn Al-As', 3, true),
('andalus', 'فتح الأندلس', 'Conquest of Al-Andalus',
 ...
 'Tariq ibn Ziyad crossed the strait and conquered the Iberian Peninsula, beginning a flourishing civilization.', '92 هـ', '711 م', 'شبه الجزيرة الإيبيرية', 'Iberian Peninsula', 'طارق بن زياد', 'Tariq ibn Ziyad', 4, true),
('constantinople', 'فتح القسطنطينية', 'Conquest of Constantinople',
 ...
 'Sultan Mehmed II conquered Constantinople, fulfilling the prophecy of the Prophet.', '857 هـ', '1453 م', 'القسطنطينية', 'Constantinople', 'محمد الفاتح', 'Mehmed the Conqueror', 5, true)
ON CONFLICT (slug) DO NOTHING;
