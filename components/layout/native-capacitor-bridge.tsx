...
type CapacitorWindow = Window & {
  ...
  zikrNative?: {
    ...
    scheduleLocalNotification: (notification: { id: number; title: string; body: string; scheduleAt?: string; sound?: string }) => Promise<void>;
  };
};
        ...
        notifications: [
          {
            ...
            schedule: notification.scheduleAt ? { at: new Date(notification.scheduleAt) } : undefined,
          },
        ],
      });
    },
